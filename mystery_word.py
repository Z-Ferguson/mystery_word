...
# easy list (4-6 characters), normal (6-8 characters), hard(8 letters or more)
...
def draw_word(right_guess, wrong_guess, secret_word):
    ...
    check_game_state(letters_remaining)


def check_game_state(chars_remaining):
